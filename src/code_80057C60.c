...
void func_80059820(s32 arg0) {
    ...
    D_8018CF1C = gPlayerOne; //&gPlayerOne[arg0];
...
void func_800598D4(s32 controllerIndex) {
    struct Controller *controller = &gControllers[controllerIndex];
        ...
        if (*temp_v1 < arg1) {
            ...
            if (gModeSelection == TIME_TRIALS) {
                ...
                if (temp_v0_2 >= temp_a0_2) {
                    ...
                    temp_a1 = gPlayerOne[arg0].characterId;
                    arg0 = temp_a3;
                    sp20 = temp_v1;
...
void func_8006E058(void) {
    ...
    if (temp_v0_4 != GRAND_PRIX) {
        ...
        if ((temp_a0_3->unk_000 & PLAYER_INVISIBLE_OR_BOMB) == PLAYER_INVISIBLE_OR_BOMB) {
