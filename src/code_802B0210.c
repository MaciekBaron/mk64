...
void update_obj_triple_shell(void *arg0, s16 arg1) {
    ...
    case 4:
        ...
        temp_t7 = arg0->unk14;
        if ((gControllers[temp_t7].buttonPressed & Z_TRIG) != 0) {
    ...
    case 2:
        ...
        if (arg0->unk4 == 0) {
            ...
            if (arg0->unk0 == 0x2A) {
                ...
                temp_v0_3 = gPlayers[temp_t7].currentPosition;
                if (temp_v0_3 == 0) {
                    arg0->unk6 = 4;
                    arg0->unk4 = 0x258;
                    ...
                    arg0->unk12 = phi_v0_4;
                    arg0->unk4 = (&gPlayerPositionLookup)[gPlayers[temp_t7].currentPosition].unk-2;
                } else {
                    arg0->unk6 = 3;
                    arg0->unk8 = 1000.0f;
                    arg0->unk4 = (&gPlayerPositionLookup)[gPlayers[temp_t7].currentPosition].unk-2;
